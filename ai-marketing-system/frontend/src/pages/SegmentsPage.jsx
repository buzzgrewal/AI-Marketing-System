          ...
          <div className="flex-1 min-w-[200px]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
          <select
            ...
            className="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="border-t pt-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <select
                    ...
                    className="px-3 py-1 bg-white text-gray-700 border border-gray-300 rounded text-sm"
                  >
                    ...
                    <div key={index} className="flex flex-col sm:flex-row gap-2 items-start p-3 sm:p-4 bg-gray-50 rounded-lg">
                      <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-2 w-full">
                        <select
                          ...
                          className="px-3 py-2 bg-white text-gray-700 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                        >
                ...
                <button
                  ...
                  className="mt-3 px-4 py-2 bg-white border-2 border-dashed border-gray-300 text-gray-600 rounded-lg hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 w-full"
                >
                  + Add Condition
                </button>
              </div>
