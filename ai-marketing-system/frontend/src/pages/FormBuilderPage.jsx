...
export default function FormBuilderPage() {
  ...
  // Helper function to determine contrast color based on background
  ...
  (function() {
    ...
    fetch(\`\${apiUrl}/api/forms/slug/\${formSlug}\`)
      ...
      .then(form => {
        ...
        html += \`
            <button type="submit" style="width: 100%; padding: 0.75rem; background-color: \${form.theme_color}; color: \${getContrastColor(form.theme_color)}; border: none; border-radius: 0.375rem; font-size: 1rem; font-weight: 600; cursor: pointer;">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm"
              ...
              <div className="flex flex-wrap gap-2">
                {FIELD_TYPES.map(fieldType => (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 text-sm bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50"
                  >
            ...
            <form className="space-y-4">
              {formConfig.fields.map((field, index) => (
                <div key={index}>
                  ...
                  {field.type === 'textarea' ? (
                    ...
                    <input type="checkbox" className="w-4 h-4 rounded text-blue-600 bg-white border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 accent-blue-600" />
                  ) : (
                    <input
                      type={field.type}
                      placeholder={field.placeholder}
              ...
              {formConfig.require_consent && (
                <div className="flex items-start gap-2">
                  <input type="checkbox" className="mt-1 w-4 h-4 rounded text-blue-600 bg-white border-gray-300 focus:ring-blue-500" />
              ...
              <button
                ...
                style={{
                  ...
                  color: getContrastColor(formConfig.theme_color)
                }}
